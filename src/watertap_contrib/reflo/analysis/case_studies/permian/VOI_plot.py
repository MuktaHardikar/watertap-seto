...
# Add NAWI-analysis to Python path
nawi_path = "/Users/mhardika/Documents/nawi_analysis/NAWI-analysis/analysis_generic_modules/plot_kit"
if nawi_path not in sys.path:
    sys.path.insert(0, nawi_path)
...
sweep_yaml_dir = os.path.join(os.path.dirname(parent_dir), "Permian/sweep_yamls")
sweep_results_dir = os.path.join(os.path.dirname(parent_dir), "Permian/sweep_results", "output")
