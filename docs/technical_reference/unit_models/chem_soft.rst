...
This chemical softening unit model
   ...
   * is verified against the operation data from **
...
.. csv-table::
   ...
   "Feed composition", "properties_in[0].conc_mass_comp['Ca_2+']", ":math:`X_{f}`", "30 - 60", ":math:`\text{g/}\text{L}`"
